...
read -p "(Default directory: /home/web/$domain): " vhostdir
if [ -z "$vhostdir" ]; then
        vhostdir="/home/web/$domain"
...
if [ "$access_yn" == 'n' ]; then
	...
	N_log="access_log /home/weblogs/${domain}_nginx.log combined;"
	echo -e "You access log file=\033[32m/home/weblogs/${domain}_nginx.log\033[0m"
fi
}
...
if [ "$access_yn" == 'n' ]; then
        ...
        A_log="CustomLog \"/home/weblogs/${domain}_apache.log\" common"
        echo "You access log file=/home/weblogs/${domain}_apache.log"
fi
}
...
<VirtualHost *:80>
    ServerAdmin admin@tekin.cn 
    DocumentRoot "$vhostdir"
    ServerName $domain
    $Domain_alias
    ErrorLog "/home/weblogs/${domain}_error_apache.log"
    $A_log
<Directory "$vhostdir">
