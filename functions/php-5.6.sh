...
# php-fpm56 Init Script
/bin/cp sapi/fpm/init.d.php-fpm /etc/init.d/php-fpm56
chmod +x /etc/init.d/php-fpm56
OS_CentOS='chkconfig --add php-fpm56 \n
chkconfig php-fpm56 on'
OS_Debian_Ubuntu='update-rc.d php-fpm56 defaults'
OS_command
...
[global]
pid = run/php-fpm56.pid
error_log = log/php-fpm56.log
log_level = warning 
