...
src_url=https://downloads.mariadb.org/f/mariadb-$mariadb5_version/source/mariadb-$mariadb5_version.tar.gz && Download_src 
...
tar zxf mariadb-$mariadb5_version.tar.gz
cd mariadb-$mariadb5_version
...
OS_command
cd ..
/bin/rm -rf mariadb-$mariadb5_version 
cd ..
