...
sed -i 's@^/usr/local/php/@/usr/local/php53/@' $php_install_dir/etc/php.ini
[ -e /usr/sbin/sendmail ] && sed -i 's@^;sendmail_path.*@sendmail_path = /usr/sbin/sendmail -t -i@' $php_install_dir/etc/php.ini


# php-fpm53 Init Script
/bin/cp sapi/fpm/init.d.php-fpm /etc/init.d/php-fpm53
chmod +x /etc/init.d/php-fpm53
OS_CentOS='chkconfig --add php-fpm53 \n
chkconfig php-fpm53 on'
OS_Debian_Ubuntu='update-rc.d php-fpm53 defaults'
OS_command
