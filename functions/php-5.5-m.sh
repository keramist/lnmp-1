...
# php-fpm55 Init Script
/bin/cp sapi/fpm/init.d.php-fpm /etc/init.d/php-fpm55
chmod +x /etc/init.d/php-fpm55
OS_CentOS='chkconfig --add php-fpm55 \n
chkconfig php-fpm55 on'
OS_Debian_Ubuntu='update-rc.d php-fpm55 defaults'
OS_command
