...
clear
echo "========================================================================="
echo "Upgrade MySQL for LNMP,  Written by Tekin"
echo "========================================================================="
...
function backup_mysql {
	...
	mv $initd_dir/mysql $initd_dir/mysql.bak.$upgrade_date
...
function startall {
	cp $cur_dir/mysql-$mysql_version/support-files/mysql.server $initd_dir/mysql
	chmod 755 $initd_dir/mysql
