...
cp init.d.php-fpm5.2 $initd_dir/php-fpm
...
/usr/local/php/sbin/php-fpm stop
rm -rf /usr/local/php/
cp $initd_dir/php-fpm /root/phpconf/php-fpm.old.bak
rm -f $initd_dir/php-fpm
...
cp $cur_dir/php-$php_version/sapi/fpm/init.d.php-fpm $initd_dir/php-fpm
chmod +x $initd_dir/php-fpm
...
#echo "$initd_dir/nginx start" >>/etc/rc.local
#echo "$initd_dir/php-fpm start" >>/etc/rc.local
